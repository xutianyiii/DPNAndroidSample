...
public class GLProgram {
    ...
    public void setup(int position) {
        Log.e("Deepano","position = "+ position);
        switch (position) {
            case 1:
    ...
    public void buildTextures(Buffer y, Buffer u, Buffer v, int width, int height) {
        ...
        if (videoSizeChanged) {
            ...
            Log.e("Deepano","buildTextures videoSizeChanged: w=" + _video_width + " h=" + _video_height);
        }

        // building texture for Y data
        if (_ytid < 0 || videoSizeChanged) {
            if (_ytid >= 0) {
                Log.e("Deepano","glDeleteTextures Y");
            ...
            _ytid = textures[0];
            Log.e("Deepano","glGenTextures Y = " + _ytid);
        }
        ...
        if (_utid < 0 || videoSizeChanged) {
            if (_utid >= 0) {
                Log.e("Deepano","glDeleteTextures U");
            ...
            checkGlError("glGenTextures");
            _utid = textures[0];
            Log.e("Deepano","glGenTextures U = " + _utid);
        }
        ...
        if (_vtid < 0 || videoSizeChanged) {
            if (_vtid >= 0) {
                Log.e("Deepano","glDeleteTextures V");
            ...
            checkGlError("glGenTextures");
            _vtid = textures[0];
            Log.e("Deepano","glGenTextures V = " + _vtid);
        }
    ...
    public void drawFrame() {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, _ytid);
        GLES20.glUniform1i(_yhandle, _tIindex); //2

        GLES20.glActiveTexture(_textureII);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, _utid);
        GLES20.glUniform1i(_uhandle, _tIIindex); //0

        GLES20.glActiveTexture(_textureIII);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, _vtid);
        GLES20.glUniform1i(_vhandle, _tIIIindex); // 1
    ...
    public int createProgram(String vertexSource, String fragmentSource) {
        ...
        // just check
        Log.e("Deepano","vertexShader = " + vertexShader);
        Log.e("Deepano","pixelShader = " + pixelShader);
        ...
        if (program != 0) {
            ...
            if (linkStatus[0] != GLES20.GL_TRUE) {
                Log.e("Deepano","Could not link program: ", null);
                Log.e("Deepano",GLES20.glGetProgramInfoLog(program), null);
    ...
    private int loadShader(int shaderType, String source) {
        ...
        if (shader != 0) {
            ...
            if (compiled[0] == 0) {
                Log.e("Deepano","Could not compile shader " + shaderType + ":", null);
                Log.e("Deepano",GLES20.glGetShaderInfoLog(shader), null);
    ...
    private void checkGlError(String op) {
        ...
        while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
            Log.e("Deepano","***** " + op + ": glError " + error, null);
